      ...
      <div class="grid grid-cols-1 lg:grid-cols-2 gap-4 md:gap-6">
        ...
        <div class="bg-white rounded-xl shadow-sm p-4 md:p-6">
          ...
          <div class="h-64 flex items-center justify-center bg-slate-50 rounded-lg">
            <!-- <CategoryConsumptionChart :data="consumptionData" /> -->
          </div>
        </div>
      </div>
        ...
        <div class="grid grid-cols-1 lg:grid-cols-2 gap-4 md:gap-6">
          ...
          >
            <div class="flex justify-between items-start mb-3">
              <div>
                <h3 class="text-lg font-semibold text-[#1E293B]">{{ category.name }}</h3>
              </div>
            </div>
            <div class="flex flex-col text-base text-gray-600 mb-4 space-y-2">
              ...
              <div class="flex justify-between py-2">
                <span>Limite:</span>
                <span class="font-medium">{{ formatCurrency(category.limit) }}</span>
              </div>
            </div>
...
//   import CategoryConsumptionChart from '@/Components/Charts/CategoryConsumptionChart.vue';
